...
import com.example.avocadoandroid.databinding.FragmentKnowMoreBinding
import com.example.avocadoandroid.models.UserSharedViewModel

class KnowMoreFragment : Fragment(R.layout.fragment_know_more) {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_know_more, container, false)
        return binding.root
    }
